...
print("current random seed is ", seed)
np.random.seed(seed)
...
def train(model_path='./models/CosX.pth.tar', \
          loss_path='./logs/CosX_train_loss.txt',\
          acc_path='./logs/CosX_train_acc.txt'):
...
def test(model_path='./models/CosX.pth.tar', \
         acc_path='./logs/CosX_test_acc.txt', 
    ...
    plt.title("CNN2 Classification Accuracy on RadioML 2016.10 Beta")
    plt.close()
