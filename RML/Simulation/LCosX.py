...
def train(model_path='./models/LCos.pth.tar', \
          loss_path='./logs/LCos_train_loss.txt',\
          acc_path='./logs/LCos_train_acc.txt'):
    ...
    label = torch.argmax(Y_train, -1)  # One-hot label
...
def test(model_path='./models/LCos.pth.tar', \
         acc_path='./logs/LCosX_test_acc.txt', 
