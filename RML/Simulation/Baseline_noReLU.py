...
def train(model_path='./models/Baseline_noReLU.pth.tar', \
          loss_path='./logs/Baseline_noReLU_train_loss.txt',\
          acc_path='./logs/Baseline_noReLU_train_acc.txt'):
...
def test(model_path='./models/Baseline_noReLU.pth.tar', \
         acc_path='./logs/Baseline_noReLU_test_acc.txt', 
